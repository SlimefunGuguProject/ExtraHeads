...
public class ExtraHeads extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        if (Slimefun.getMinecraftVersion().isBefore(MinecraftVersion.MINECRAFT_1_16)) {
            registerHead(EntityType.valueOf("PIG_ZOMBIE"), "74e9c6e98582ffd8ff8feb3322cd1849c43fb16b158abb11ca7b42eda7743eb");
        }
        else {
        ...
        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_16_5)) {
    ...
    public String getBugTrackerURL() {
        return "https://github.com/ybw0014/ExtraHeads-CN/issues";
    }
}
